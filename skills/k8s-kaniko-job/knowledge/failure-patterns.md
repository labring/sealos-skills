...
- Inspect `.sealos/build/kaniko-context.json` and `tar -tzf` output.
...
- Confirm `.sealos/build/kaniko-context.json.kaniko.dockerfile` points to a file inside the tar root.
