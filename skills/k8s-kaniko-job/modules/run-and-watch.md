...
Treat a failed Job as a build failure and continue to log collection before writing `.sealos/build/build-result.json`.
...
Use the classification in `.sealos/build/build-result.json`.
