...
It is acceptable for the MVP to keep Secrets while debugging. If cleanup is implemented, only delete Secrets after logs and `.sealos/build/build-result.json` are written.
