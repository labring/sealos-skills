...
Sealos Skills एक प्लगइन-प्रथम स्किल पैक है जो Sealos Cloud डेवलपमेंट और डिप्लॉयमेंट पर केंद्रित है। यह AI एजेंट को प्रोजेक्ट का निरीक्षण करने और अनुपलब्ध डिप्लॉयमेंट आर्टिफ़ैक्ट तैयार करने में मदद करता है। यह डेवलपमेंट के लिए Sealos Cloud डेटाबेस और ऑब्जेक्ट स्टोरेज जोड़ता है। यह कंटेनर इमेज बनाता या दोबारा उपयोग करता है, ऐप को Sealos Cloud पर डिप्लॉय करता है, और डिप्लॉय किए गए संसाधनों को स्थानीय केवल-पढ़ने योग्य कैनवास में दिखाता है।

एक `npx plugins add` कमांड प्लगइन को हर पहचाने गए एजेंट टूल में इंस्टॉल करता है। Codex और Claude Code के मूल marketplace इंस्टॉलेशन एक ही रूट `skills/**` स्रोत का उपयोग करते हैं। `skills.sh` और Gemini CLI तथा Qwen Code जैसे केवल-कॉन्टेक्स्ट एक्सटेंशन होस्ट भी इसका उपयोग करते हैं।
...
एक कमांड Sealos प्लगइन को हर पहचाने गए एजेंट टूल में इंस्टॉल करता है: Claude Code, Cursor, Codex, Grok Build, Kimi Code, GitHub Copilot CLI, और VS Code। पहचाने गए टूल की सूची देखने के लिए `npx plugins targets` चलाएँ, या केवल एक टूल में इंस्टॉल करने के लिए `--target <tool>` पास करें।

### Codex में नेटिव इंस्टॉल करें
...
प्लगइन रूट `skills/**` डायरेक्टरी से सभी आठ स्किल इंस्टॉल करता है। हर स्किल क्या करती है, यह जानने के लिए नीचे **शामिल स्किल** देखें।

Codex में इंस्टॉल करने के बाद प्लगइन का उपयोग Codex से करें:
...
### Claude Code में नेटिव इंस्टॉल करें
...
| --- | --- | --- |
| Codex CLI / Codex App | `npx plugins add https://github.com/labring/sealos-skills --target codex`, या ऊपर **Codex में नेटिव इंस्टॉल करें** देखें | Codex CLI में `$sealos`, या Codex App में **+** → **Plugins** → **Sealos** |
| Claude Code | `npx plugins add https://github.com/labring/sealos-skills --target claude-code`, या ऊपर **Claude Code में नेटिव इंस्टॉल करें** देखें | `/sealos` |
| Cursor / Grok Build / Kimi Code / Copilot CLI / VS Code | `npx plugins add https://github.com/labring/sealos-skills` | इंस्टॉल के बाद होस्ट कमांड एंट्री |
...
| Amp / सामान्य रिपॉज़िटरी इंपोर्टर | `https://github.com/labring/sealos-skills.git` इंपोर्ट करें | होस्ट पर निर्भर |
...
`/sealos-deploy`, `/sealos-database`, और `/sealos-s3`, `skills.sh` की सीधी स्किल एंट्री हैं। प्लगइन उपयोग के लिए Codex में `$sealos` या Claude Code में `/sealos` का उपयोग करना आवश्यक है।
...
जब कोई डिप्लॉयमेंट मौजूद हो, तो बाद के रन उसी स्थान पर अपडेट करने वाले प्रवाह पर चले जाते हैं।
...
- पुष्टि मिलने के बाद ही सार्वजनिक एक्सेस प्रबंधित करता है
...
- पुष्टि मिलने के बाद ही बकेट सार्वजनिक करता है या क्रेडेंशियल बदलता है
...
वास्तविक डिप्लॉयमेंट के लिए Sealos Cloud खाता और कंटेनर रजिस्ट्री एक्सेस चाहिए। स्किल शुरू होने के बाद यह आपको इस सेटअप में मार्गदर्शन कर सकती है। डेटाबेस और ऑब्जेक्ट स्टोरेज कार्य के लिए Sealos Cloud खाता और अनुरोधित संसाधन बनाने में सक्षम workspace चाहिए।
...
Codex, Claude Code और अन्य समर्थित एजेंट टूल के लिए प्लगइन इंस्टॉलेशन अनुशंसित है क्योंकि यह:
...
## इस रिपॉज़िटरी का रखरखाव

नीचे दिए गए अनुभाग रिपॉज़िटरी रखरखावकर्ताओं और प्लगइन प्रकाशकों के लिए हैं। उपयोगकर्ताओं को इनकी आवश्यकता नहीं है।
...
- `.qoder-plugin/plugin.json` Qoder प्लगइन सतह परिभाषित करता है और सभी आठ Codex स्किल स्पष्ट रूप से उपलब्ध कराता है।
- `qoder.md` स्किल कार्यान्वयन की नकल किए बिना Qoder-स्तरीय रूटिंग और सुरक्षा निर्देश देता है।
...
- `scripts/package-qoder-plugin.py` आर्काइव रूट पर प्लगइन मैनिफ़ेस्ट के साथ Qoder-संगत ZIP बनाता है।
...
- [`.qoder-plugin/plugin.json`](../.qoder-plugin/plugin.json) — Qoder प्लगइन मैनिफ़ेस्ट
- [`qoder.md`](../qoder.md) — Qoder प्लगइन रूटिंग और सुरक्षा निर्देश
...
- [`scripts/package-qoder-plugin.py`](../scripts/package-qoder-plugin.py) — Qoder ZIP पैकेजर
